...
const features = [
  {
    ...
    description: "Premium, performance-first websites with SEO and conversion in mind — modern frontends, fast load times.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "SaaS Development",
    description: "Scalable product engineering for startups: architecture, APIs, and product-ready deployments.",
    visual: "collab",
  },
  {
    number: "03",
    title: "AI Solutions",
    description: "Custom AI integrations, chatbots, and automation that amplify user experiences and growth.",
    visual: "ai",
  },
  {
    number: "04",
    title: "Digital Marketing",
    description: "Data-driven acquisition: SEO, paid media, and creative that moves the needle for growth.",
    visual: "deploy",
  },
  {
    number: "05",
    title: "Branding & UI/UX",
    description: "Strategic brand identity and product design that feel modern, cohesive, and premium.",
    visual: "collab",
  },
  {
    number: "06",
    title: "Mobile App Development",
    description: "Cross-platform apps built with performance and delightful UX as priorities.",
    visual: "security",
  },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        const x = parseFloat((100 + Math.cos(angle) * radius).toFixed(3));
        const y = parseFloat((80 + Math.sin(angle) * radius).toFixed(3));
        return (
          <g key={i}>
            {/* Connection line */}
            <line
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Core services for product-led growth.
            <br />
            <span className="text-muted-foreground">Premium execution, AI-first approach.</span>
          </h2>
        </div>
